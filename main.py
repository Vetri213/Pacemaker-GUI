...
def show_aai_mode_page():
    ...
    atrial_sensitivity_label.pack(pady=10)
    atrial_sensitivity_entry.pack(pady=10)
    ...
    pvarp_label.pack(pady=10)
    pvarp_entry.pack(pady=10)
    ...
    hysteresis_label.pack(pady=10)
    hysteresis_entry.pack(pady=10)
    ...
    rate_smoothing_label.pack(pady=10)
    rate_smoothing_entry.pack(pady=10)
...
def show_vvi_mode_page():
    ...
    ventricular_sensitivity_label.pack(pady=10)
    ventricular_sensitivity_entry.pack(pady=10)
